...
class ListFavoriteRestaurant extends HTMLElement {
  set favoriteRestaurant(data) {
    this._restaurant = data;
    this.render();
  }

  render() {
    const dataRestaurant = this._restaurant;
...
customElements.define('list-favorite', ListFavoriteRestaurant);
